...
Frontend: **Next.js** (`frontend-next/`). Chat with live answer streaming, clickable citations and sources, mail edit panel that can be reopened after closing, discarded, given a 15-second undo window before sending, and corrected after it was sent.
